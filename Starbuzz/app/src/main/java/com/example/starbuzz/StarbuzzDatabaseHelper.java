...
public class StarbuzzDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
       db.execSQL("CREATE TABLE DRINK("
        ...
        insertDrink(db, "Latte", "Different", R.drawable.latte);
    ...
    private static void insertFood(SQLiteDatabase db,String name,
        ...
        db.insert("DRINK", null, foodValues);
    }
    ...
    private static void insertStore(SQLiteDatabase db,String name,
        ...
        db.insert("DRINK", null, storeValues);
    }
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion){
        if(oldVersion<1) {
            ...
            insertDrink(db, "Latte", "This is different", R.drawable.latte);
            insertDrink(db, "Cappuccino", "Espresso, hot milk and steamed-milk foam", R.drawable.cappuccino);
            insertDrink(db, "Filter", "Our best drip coffee", R.drawable.filter);
